...
function parsing_kinopoisk ( id_films, step )
    ...
    var id_news = '{$news_nomer}';
    var avtor = '{$avtor}';
    var editnews_pkfdle = '{$editnews_pkfdle}';
    ...
    myParser.innerHTML = '';
		...
		$.post('{$config['http_home_url']}engine/modules/parser-kinopoisk/parser_kinopoisk.php', { id_kinopoisk: id_kinopoisk, kino_film: kino_film, id_postersv: id_postersv, id_screenv: id_screenv, id_stillsv: id_stillsv, id_wallv: id_wallv, id_postes: id_postes, steps: steps, id_news: id_news, avtor: avtor, editnews_pkfdle: editnews_pkfdle }, function(data){
