...
switch ( $do ) {
	...
	// Api:Requests
		case "login": include ENGINE_DIR . '/modules/for_login_api.php';

		break;

	case "category": include ENGINE_DIR . '/modules/for_category_api.php';

		break;


	case 'table': include ENGINE_DIR . '/modules/for_table_api.php';

		break;



	case "reg": include ENGINE_DIR . '/modules/for_reg_api.php';

		break;

	case "searchtable": include ENGINE_DIR . '/modules/for_searchtable_api.php';

		break;


	case 'onepost': include ENGINE_DIR . '/modules/for_onepost_api.php';

		break;



	case 'populartable': include ENGINE_DIR . '/modules/for_populartable_api.php';

		break;



	case "authorization": include ENGINE_DIR . '/modules/authorization.php';
