	...
	<div class="cols-mov clearfix ignore-select">
		...
		<div class="col-mov-right">
			...
			[xfgiven_rating]<div class="r-kp" data-label="KP"><font color="green">[xfvalue_rating]</font></div> [/xfgiven_rating]
                ...
                <b>Автор новости:</b> {author}. &nbsp <b>Дата:</b> {date}
			</div>
			<ul class="mov-list">
				[xfgiven_year]<li><div class="mov-label">Год:</div> <div class="mov-desc">[xfvalue_year]</div></li>[/xfgiven_year]
				<li><div class="mov-label">Жанр:</div> <div class="mov-desc">{link-category}</div></li>
				[xfgiven_country]<li><div class="mov-label">Страна:</div> <div class="mov-desc">[xfvalue_country]</div></li>[/xfgiven_country]
				[xfgiven_director]<li><div class="mov-label">Режиссер:</div> <div class="mov-desc">[xfvalue_director]</div></li>[/xfgiven_director]
				[xfgiven_actors]<li><div class="mov-label">В главных ролях:</div> <div class="mov-desc">[xfvalue_actors]</div></li>[/xfgiven_actors]
				[xfgiven_produser]<li><div class="mov-label">Продюсер:</div> <div class="mov-desc">[xfvalue_produser]</div></li>[/xfgiven_produser]
 				[xfgiven_sound]<li><div class="mov-label">Перевод:</div> <div class="mov-desc">[xfvalue_sound]</div></li>[/xfgiven_sound]
...
<!--			 [xfgiven_trailer]<div class="mov-desc-text full-text clearfix" data-slice="200">[/xfgiven_trailer] -->
    ...
    <br>
    <br>
    <div class="namegats">Cкриншоты:</div>
    <br>
    <br>
    <br>
  ...
  <br />
 [xfgiven_ssilka] <h3><center><a class="button black" href="[xfvalue_ssilka]" >Скачать: [xfvalue_filename]</a></center></h3> [/xfgiven_ssilka]
        <br>
    <br>
...
<!--			 [xfgiven_trailer]</div>[/xfgiven_trailer] -->
	...
	<div class="tabsbox ignore-select">
		<div class="tabs-sel">
			 [xfgiven_online]<span>Смотреть онлайн</span> [/xfgiven_online]
			 [xfgiven_trailer]<span>Трейлер</span>[/xfgiven_trailer]
		</div>
